...
@section('content')
                            ...
                            @foreach ($services as $service)
                                <tr class="odd">
                                    ...
                                    <td data-filter="mastercard">
                                        <img src="{{ asset('media/' . $service->image) }}" class="w-100px rounded me-3"
                                            alt="">
                                    </td>
                                    <!--end::description=-->
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="{{ route('show.service', $service->id) }}" class="menu-link px-3">
                                            ...
                                            <div class="menu-item px-3">
                                                <form
                                                    action="{{ route('delete.service', ['id' => $service->id, 'image' => $service->image]) }}"
                                                    method="POST"
    ...
    <div class="modal" id="kt_modal_add_customer" tabindex="-1" role="dialog">
        <!--begin::Modal dialog-->
