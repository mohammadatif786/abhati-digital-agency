        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    ...
                    <!--begin::Add customer-->
                    <button type="button" class="btn btn-primary categoryAddModal" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_add_project">Add Category</button>
                    <!--end::Add customer-->
                </div>
                <!--end::Toolbar-->
                <!--begin::Group actions-->
        ...
        <div class="card-body pt-0">
            ...
            <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_category_table">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    ...
                                                    <a id="editCategoryModal" data-id="{{ $category->id }}"
                                                        class="menu-link px-3 editCategoryModal">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a id="deleteCategory" data-id="{{ $category->id }}"
